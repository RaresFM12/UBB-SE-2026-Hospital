namespace Hospital.Desktop.ViewModels.Admin
{
    ...
    public sealed class FatigueShiftAuditViewModel : ObservableObject
    {
        ...
        public void RunAutoAudit()
        {
            ...
            DateTime GetViolationShiftStart(AuditViolation violation) => violation.ShiftStart;
            ...
            int GetSuggestionShiftId(AutoSuggestRecommendation suggestion) => suggestion.ShiftId;
