namespace Hospital.Shared.Services
{
    ...
    public class OrderService : IOrderService
    {
        ...
        public OrderService()
        {
            ...
            this.SubstancesRepository = Hospital.Shared.SharedServiceProvider.Services.GetRequiredService<ISubstancesRepository>();
            this.ItemsRepository = Hospital.Shared.SharedServiceProvider.Services.GetRequiredService<IItemsRepository>();
            this.UsersRepository = Hospital.Shared.SharedServiceProvider.Services.GetRequiredService<IUsersRepository>();
            this.OrdersRepository = Hospital.Shared.SharedServiceProvider.Services.GetRequiredService<IOrdersRepository>();
            this.EvaluationsRepository = Hospital.Shared.SharedServiceProvider.Services.GetRequiredService<IEvaluationsRepository>();
            this.basketRepository = Hospital.Shared.SharedServiceProvider.Services.GetService<IBasketRepository>();
            ...
            IBasketRepository? basketRepository = null)
        {
            ...
            this.EvaluationsRepository = evaluationsRepository ?? Hospital.Shared.SharedServiceProvider.Services.GetRequiredService<IEvaluationsRepository>();
