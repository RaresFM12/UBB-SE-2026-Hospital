...
{
    private const string LocalDbConnectionString = "Data Source=(localdb)\\mssqllocaldb;Initial Catalog=HospitalDatabase;Integrated Security=True;Encrypt=False;Trust Server Certificate=True;";
