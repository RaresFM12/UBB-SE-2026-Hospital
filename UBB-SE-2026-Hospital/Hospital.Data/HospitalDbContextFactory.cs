...
{
    private const string LocalDbConnectionString = "Server=(localdb)\\mssqllocaldb;Database=HospitalDB;Trusted_Connection=True;MultipleActiveResultSets=true;Encrypt=False;";
