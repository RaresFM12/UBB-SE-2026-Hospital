...
public class HospitalDbContextFactory : IDesignTimeDbContextFactory<HospitalDbContext>
{
    ...
    private const string LocalDbConnectionString = "Data Source=.\\SQLEXPRESS;Initial Catalog=HospitalDatabase_Dev;Integrated Security=True;Encrypt=True;Trust Server Certificate=True;";
