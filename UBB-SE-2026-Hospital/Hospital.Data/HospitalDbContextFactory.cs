...
{
    private const string LocalDbConnectionString = "Server=localhost\\SQLEXPRESS;Database=HospitalDatabase;Trusted_Connection=True;TrustServerCertificate=True;";
